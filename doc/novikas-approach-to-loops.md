...
Novika is written in Crystal. Even though you won't find a "looping primitive" in the list of
essential capabilities or anywhere else, there still is a loop at the core of the interpreter which is
